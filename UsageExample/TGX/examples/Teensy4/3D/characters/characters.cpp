...
void update ()
{
	...
	/*libTeensyRawHid_WriteArea(&ctx, fb, 0, 0, ctx.width-1, (ctx.height>>1)-1);
	...
	for (int i = 0; i < strips; i++){
		...
		libTeensyRawHid_WriteArea(&ctx, pixels, 0, i*stripHeight, ctx.width-1, (i*stripHeight)+stripHeight-1);
	}*/
