...
#ifndef _GC9A01A_SPI_H_
#define _GC9A01A_SPI_H_
...
#define GC9A01A_TFTWIDTH	TFT_WIDTH
#define GC9A01A_TFTHEIGHT	TFT_HEIGHT
...
#define GC9A01A_SPICLOCK 100		// mhz
#define GC9A01A_SPICLOCK_READ 20000000
#else
//#define GC9A01A_SPICLOCK 96000000
//#define GC9A01A_SPICLOCK_READ 2000000
#endif
...
public:
  ...
  void begin (uint32_t spi_clock = GC9A01A_SPICLOCK, uint32_t spi_clock_read = GC9A01A_SPICLOCK_READ);
...
// Add DMA support.
  static GC9A01A_SPI *_dmaActiveDisplay[3]; // Use pointer to this as a way to
