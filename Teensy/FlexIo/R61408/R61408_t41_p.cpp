...
PROGMEM static const setting_table_t power_on_setting_table[] = {
	{R61408_RESET,     0, {0x00}, 100},
	{R61408_SLPOUT,    0, {0x00}, 20},
	{R61408_DISLYON,   0, {0x00}, 120},
	{R61408_MCAP,      1, {0x04}, 0},
	{R61408_FMAIS,     2, {0x02, 0x00}, 0},
	{R61408_DSICTL,    2, {0x52, 0x83}, 0},
	{0xB7,             4, {0x80, 0x72, 0x11, 0x25}, 0},
	{R61408_BLCTRL1,   20,{0x00, 0x0F, 0x0F, 0xFF, 0xFF, 0xC8, 0xC8, 0x02, 0x18, 0x10, 0x10, 0x37, 0x5A, 0x87, 0xBE, 0xFF, 0x00, 0x00, 0x00, 0x00}, 0},
	{R61408_BLCTRL1,   4, {0x00, 0x00, 0x00, 0x00}, 0},
	{R61408_RESCTL,    1, {0x00}, 0},
	{R61408_PANDSET,   2, {0x02, 0x76}, 0},
	{R61408_DTSNM,     15,{0x63, 0x31, 0x00, 0x27, 0x27, 0x32, 0x12, 0x28, 0x4E, 0x10, 0xA5, 0x0F, 0x58, 0x21, 0x01}, 0},
	{R61408_DVTIME,    6, {0x28, 0x06, 0x06, 0x01, 0x03, 0x00}, 0},
	{R61408_PANDRV3,   2, {0x00, 0x01}, 0},
	{R61408_OSCCTRL,   2, {0x00, 0x00}, 0},
	{R61408_PANDRV4,   5, {0x11, 0x8D, 0xA0, 0xF5, 0x27}, 0},
	{R61408_GAMSETA,   24,{0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02, 0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02}, 0},
	{R61408_GAMSETB,   24,{0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02, 0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02}, 0},
	{R61408_GAMSETB,   24,{0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02, 0x02, 0x13, 0x18, 0x25, 0x34, 0x4E, 0x36, 0x23, 0x17, 0x0E, 0x0C, 0x02}, 0},
	{R61408_PSCPSET,   16,{0xA9, 0x03, 0xCC, 0xA5, 0x00, 0x53, 0x20, 0x10, 0x01, 0x00, 0x01, 0x01, 0x00, 0x03, 0x01, 0x00}, 0},
	{R61408_VCOMSET,   7, {0x18, 0x0C, 0x23, 0x03, 0x75, 0x02, 0x50}, 0},
	{R61408_PWRSAV,    1, {0x33}, 0},
	{R61408_VPVNLVL,   2, {0x2A, 0x2A}, 0},
	{R61408_VCOMDC,    2, {0x01, 0x51}, 0},
	{R61408_DDBWCTL,   6, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0},
	{R61408_VCOMDC2,   1, {0x55}, 0},
	{R61408_VDCSEL,    1, {0x01}, 0},
	{R61408_MCAP,      1, {0x04}, 40},
	{R61408_SCANTEON,  1, {0x00}, 0},
	{R61408_SCANLINE,  1, {0x00}, 0},
	{R61408_MADCTL,    1, {0x00}, 0},
	{R61408_SETPIXF,   1, {0x55}, 0}
};

FLASHMEM void R61408_t41_p::LCDSettingTableWrite (const setting_table_t *table)
{
...
FLASHMEM void R61408_t41_p::setRotation (const uint8_t r) 
{ 
	_rotation = r&0x03;

	switch (_rotation){
      case 0:	
      case 2: _width  = R61408_TFTWIDTH;
              _height = R61408_TFTHEIGHT;
             break;
      case 1: 
      case 3: _width  = R61408_TFTHEIGHT;
              _height = R61408_TFTWIDTH;
			 break;
	}

	SglBeatWR_nPrm_8(R61408_MADCTL, &MADCTL[_rotation], 1);
	delay(1);
}

FLASHMEM void R61408_t41_p::init_display ()
{		
...
FLASHMEM void R61408_t41_p::setBacklight (const uint8_t value)
{
    analogWrite(_bl, value&0x7F);
}

FLASHMEM void R61408_t41_p::begin (const uint8_t baud_div) 
{
	...
	*(portControlRegister(_rst)) = 0xFF;
	...
	_width  = R61408_TFTWIDTH;
	_height = R61408_TFTHEIGHT;

}

FLASHMEM void R61408_t41_p::onCompleteCB (CBF callback)
{
	_callback = callback;
	isCB = true;
}

FASTRUN void R61408_t41_p::setAddrWindow (uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2) 
{
	uint8_t CommandValue[4];
		
	uint8_t Command = R61408_CASET;
...
FASTRUN void R61408_t41_p::pushPixels16bit (const uint16_t *pcolors, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)
{
	...
	SglBeatWR_nPrm_16(R61408_RAMWR, pcolors, area);
...
FASTRUN void R61408_t41_p::pushPixels16bitAsync (const uint16_t *pcolors, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)
{	
	while (WR_IRQTransferDone == false){
    	//Wait for any DMA transfers to complete
	}
	...
	if (!((_lastx1 == x1) && (_lastx2 == x2) && (_lasty1 == y1) && (_lasty2 == y2))){
  	...
  	MulBeatWR_nPrm_IRQ(R61408_RAMWR, pcolors, area);
...
FLASHMEM void R61408_t41_p::displayInit () 
{
...
FASTRUN void R61408_t41_p::CSLow () 
{
	digitalWriteFast(_cs, LOW);      // Select TFT
}

FASTRUN void R61408_t41_p::CSHigh () 
{
	digitalWriteFast(_cs, HIGH);     // Deselect TFT
}

FASTRUN void R61408_t41_p::DCLow () 
{
	digitalWriteFast(_dc, LOW);      // Writing command to TFT
}

FASTRUN void R61408_t41_p::DCHigh () 
{
...
FASTRUN void R61408_t41_p::microSecondDelay ()
{
...
FASTRUN inline void R61408_t41_p::gpioWrite ()
{
...
FASTRUN inline void R61408_t41_p::gpioRead ()
{
...
FASTRUN void R61408_t41_p::FlexIO_Init ()
{
...
FASTRUN void R61408_t41_p::FlexIO_Config_SnglBeat_Read ()
{
    gpioWrite();
...
FASTRUN void R61408_t41_p::FlexIO_Config_SnglBeat ()
{
    gpioWrite();
...
FASTRUN void R61408_t41_p::FlexIO_Config_MultiBeat ()
{
    //uint32_t i;
...
FASTRUN void R61408_t41_p::SglBeatWR_nPrm_8(uint32_t const cmd, const uint8_t *value = NULL, uint32_t const length = 0)
{
	while (WR_IRQTransferDone == false){
   		//Wait for any DMA transfers to complete
	}
...
FASTRUN void R61408_t41_p::SglBeatWR_nPrm_16 (uint32_t const cmd, const uint16_t *value, uint32_t const _length)
{
...
FASTRUN uint8_t R61408_t41_p::readCommand (const uint16_t cmd)
{
  while(WR_IRQTransferDone == false)
  {
    //Wait for any DMA transfers to complete
...
R61408_t41_p * R61408_t41_p::IRQcallback = nullptr;


FASTRUN void R61408_t41_p::MulBeatWR_nPrm_IRQ (uint32_t const cmd,  const void *value, uint32_t const length) 
{
	while(WR_IRQTransferDone == false){
		//Wait for any DMA transfers to complete
	}
...
FASTRUN void R61408_t41_p::_onCompleteCB ()
{
	if (_callback)
        _callback();
}

FASTRUN void R61408_t41_p::flexIRQ_Callback ()
{
