#ifndef _NT35510_t41_p_H_
#define _NT35510_t41_p_H_
...
#define MADCTL_ARRAY { 	MADCTL_MX | MADCTL_RGB, 							\
						...
						MADCTL_MX /*| MADCTL_MY*/ | MADCTL_MV | MADCTL_RGB |MADCTL_MH }
...
class NT35510_t41_p {
  public:
    NT35510_t41_p (int8_t dc, int8_t cs = -1, int8_t rst = -1, int8_t bl = 33);
  ...
  const FlexIOHandler::FLEXIO_Hardware_t *hw;
    ...
    static NT35510_t41_p *IRQcallback;
    
};
#endif //__cplusplus
#endif //_INT35510_t41_p_H_
#endif
